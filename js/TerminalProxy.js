...
WireIt.TerminalProxy = function(terminal, options) {
  ...
  /**
   * El where the terminal can move (typically the Layer)
   */
...
lang.extend(WireIt.TerminalProxy, YAHOO.util.DDProxy, {
  ...
  /**
   * Define the constraints of the region, see http://developer.yahoo.com/yui/examples/dragdrop/dd-region.html
   * @method initConstraints
   */
  initConstraints: function() {
            //Get the top, right, bottom and left positions
            var region = YAHOO.util.Dom.getRegion(this.regionEl);
